...
- Focus: log collection, event normalization, search readiness, correlation analysis, timeline reconstruction, and logging evidence generation.
...
This lab validates logging and correlation-oriented scenarios by preparing log collection boundaries, event normalization, search validation, correlation analysis, timeline reconstruction, and evidence outputs for mapped scenarios.
