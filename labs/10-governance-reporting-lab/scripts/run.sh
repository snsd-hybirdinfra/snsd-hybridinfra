...
echo "[INFO] SNSD governance reporting runtime orchestration started"
...
echo "[STEP] setup governance reporting workspace"
bash "${LAB_DIR}/scripts/setup.sh"

echo "[STEP] validate governance runtime evidence aggregation"
...
| Signal | Status |
|---|---|
| Governance reporting setup | PASS |
| Runtime evidence aggregation | PASS |
| Governance report generation | PASS |
