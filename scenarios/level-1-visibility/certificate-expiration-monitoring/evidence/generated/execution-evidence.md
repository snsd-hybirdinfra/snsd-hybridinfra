# Execution Evidence - Certificate Expiration Monitoring

## Execution Context

This scenario models an operational workflow for **certificate lifecycle** in the **Visibility** lifecycle.
