...
This scenario documents replication failure correlation within the Correlation and Analysis lifecycle. It focuses on multi-signal correlation, dependency analysis, and service impact reasoning.
...
- Define the operational condition represented by **Replication Failure Correlation**.
...
- [filesystem-failure-correlation](/scenarios/level-2-correlation/filesystem-failure-correlation)

### Downstream Scenarios

- [replication-recovery-orchestration](/scenarios/level-3-recovery/replication-recovery-orchestration)
...
**Replication Failure Correlation** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
