...
| Field | Value |
|---|---|
| Scenario Name | service-mesh-latency-correlation |
...
| Status | draft |
| Scenario Path | scenarios/level-2-correlation/service-mesh-latency-correlation |

---

## Overview

This scenario documents service mesh latency correlation within the Correlation and Analysis lifecycle. It focuses on multi-signal correlation, dependency analysis, and service impact reasoning.
...
- Define the operational condition represented by **Service Mesh Latency Correlation**.
...
**Service Mesh Latency Correlation** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
