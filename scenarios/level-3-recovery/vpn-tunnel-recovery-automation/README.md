...
| Status | draft |
| Scenario Path | scenarios/level-3-recovery/vpn-tunnel-recovery-automation |

---

## Overview

This scenario documents vpn tunnel recovery automation within the Recovery and Automation lifecycle. It focuses on incident response, recovery workflow execution, and restoration validation.
...
- Define the operational condition represented by **Vpn Tunnel Recovery Automation**.
...
- [vpn-tunnel-instability-analysis](/scenarios/level-2-correlation/vpn-tunnel-instability-analysis)
...
**Vpn Tunnel Recovery Automation** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
