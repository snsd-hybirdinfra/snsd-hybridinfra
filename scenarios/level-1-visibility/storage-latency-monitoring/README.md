...
This scenario documents storage latency monitoring within the Visibility and Detection lifecycle. It focuses on visibility, telemetry collection, health detection, and operational status awareness.
...
- Define the operational condition represented by **Storage Latency Monitoring**.
...
- [object-storage-health-monitoring](/scenarios/level-1-visibility/object-storage-health-monitoring)
- [storage-capacity-monitoring](/scenarios/level-1-visibility/storage-capacity-monitoring)
...
**Storage Latency Monitoring** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
