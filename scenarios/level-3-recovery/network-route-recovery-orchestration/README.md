...
| Field | Value |
|---|---|
| Scenario Name | network-route-recovery-orchestration |
...
| Status | draft |
| Scenario Path | scenarios/level-3-recovery/network-route-recovery-orchestration |

---

## Overview

This scenario documents network route recovery orchestration within the Recovery and Automation lifecycle. It focuses on incident response, recovery workflow execution, and restoration validation.

This scenario belongs to the **Recovery and Automation** lifecycle area and focuses on **Infrastructure Operations** within a **Hybrid Infrastructure** environment.
...
- Define the operational condition represented by **Network Route Recovery Orchestration**.
...
- [cross-site-network-correlation](/scenarios/level-2-correlation/cross-site-network-correlation)
- [network-packet-loss-correlation](/scenarios/level-2-correlation/network-packet-loss-correlation)

### Same-Level Scenarios

- [cluster-node-recovery-orchestration](/scenarios/level-3-recovery/cluster-node-recovery-orchestration)
- [compute-failover-orchestration](/scenarios/level-3-recovery/compute-failover-orchestration)
- [data-recovery-orchestration](/scenarios/level-3-recovery/data-recovery-orchestration)

### Downstream Scenarios

- [cross-region-network-resilience](/scenarios/level-4-resilience/cross-region-network-resilience)

### Cross-Domain Scenarios

- [enterprise-network-continuity](/scenarios/level-5-continuity/enterprise-network-continuity)
- [network-path-visibility](/scenarios/level-1-visibility/network-path-visibility)

---
## Summary

**Network Route Recovery Orchestration** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
