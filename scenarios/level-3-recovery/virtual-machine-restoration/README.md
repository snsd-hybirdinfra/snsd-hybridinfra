...
This scenario documents virtual machine restoration within the Recovery and Automation lifecycle. It focuses on incident response, recovery workflow execution, and restoration validation.
...
- Define the operational condition represented by **Virtual Machine Restoration**.
...
- [virtual-machine-health-monitoring](/scenarios/level-1-visibility/virtual-machine-health-monitoring)

---
## Summary

**Virtual Machine Restoration** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
