...
| Field | Value |
|---|---|
| Scenario Name | multi-region-latency-correlation |
...
| Status | draft |
| Scenario Path | scenarios/level-2-correlation/multi-region-latency-correlation |

---

## Overview

This scenario documents multi region latency correlation within the Correlation and Analysis lifecycle. It focuses on multi-signal correlation, dependency analysis, and service impact reasoning.
...
- Define the operational condition represented by **Multi Region Latency Correlation**.
...
- [storage-latency-monitoring](/scenarios/level-1-visibility/storage-latency-monitoring)
- [vpn-latency-visibility](/scenarios/level-1-visibility/vpn-latency-visibility)
...
**Multi Region Latency Correlation** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
