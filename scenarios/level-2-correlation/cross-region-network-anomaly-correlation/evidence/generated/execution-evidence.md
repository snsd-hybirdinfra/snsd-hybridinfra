# Execution Evidence - Cross Region Network Anomaly Correlation

## Execution Context

This scenario models an operational workflow for **network infrastructure** in the **Correlation** lifecycle.
