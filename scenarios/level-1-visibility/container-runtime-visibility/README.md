...
This scenario documents container runtime visibility within the Visibility and Detection lifecycle. It focuses on visibility, telemetry collection, health detection, and operational status awareness.
...
- Define the operational condition represented by **Container Runtime Visibility**.
...
- [container-failover-automation](/scenarios/level-3-recovery/container-failover-automation)
- [platform-runtime-restoration](/scenarios/level-3-recovery/platform-runtime-restoration)

---
## Summary

**Container Runtime Visibility** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
