...
| Field | Value |
|---|---|
| Scenario Name | security-policy-violation-analysis |
...
| Status | draft |
| Scenario Path | scenarios/level-2-correlation/security-policy-violation-analysis |

---

## Overview

This scenario documents security policy violation analysis within the Correlation and Analysis lifecycle. It focuses on multi-signal correlation, dependency analysis, and service impact reasoning.
...
- Define the operational condition represented by **Security Policy Violation Analysis**.
...
**Security Policy Violation Analysis** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
