...
| Field | Value |
|---|---|
| Scenario Name | kubernetes-service-recovery |
...
| Status | draft |
| Scenario Path | scenarios/level-3-recovery/kubernetes-service-recovery |

---

## Overview

This scenario documents kubernetes service recovery within the Recovery and Automation lifecycle. It focuses on incident response, recovery workflow execution, and restoration validation.
...
- Define the operational condition represented by **Kubernetes Service Recovery**.
...
**Kubernetes Service Recovery** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
