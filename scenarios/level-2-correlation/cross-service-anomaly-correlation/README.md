...
| Field | Value |
|---|---|
| Scenario Name | cross-service-anomaly-correlation |
...
| Status | draft |
| Scenario Path | scenarios/level-2-correlation/cross-service-anomaly-correlation |

---

## Overview

This scenario documents cross service anomaly correlation within the Correlation and Analysis lifecycle. It focuses on multi-signal correlation, dependency analysis, and service impact reasoning.
...
- Define the operational condition represented by **Cross Service Anomaly Correlation**.
...
**Cross Service Anomaly Correlation** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
