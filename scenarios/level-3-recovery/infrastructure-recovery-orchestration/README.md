...
| Field | Value |
|---|---|
| Scenario Name | infrastructure-recovery-orchestration |
...
| Status | draft |
| Scenario Path | scenarios/level-3-recovery/infrastructure-recovery-orchestration |

---

## Overview

This scenario documents infrastructure recovery orchestration within the Recovery and Automation lifecycle. It focuses on incident response, recovery workflow execution, and restoration validation.
...
- Define the operational condition represented by **Infrastructure Recovery Orchestration**.
...
**Infrastructure Recovery Orchestration** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
