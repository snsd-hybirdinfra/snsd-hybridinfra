...
| Field | Value |
|---|---|
| Scenario Name | cross-region-kubernetes-resilience |
...
| Status | draft |
| Scenario Path | scenarios/level-4-resilience/cross-region-kubernetes-resilience |

---

## Overview

This scenario documents cross region kubernetes resilience within the Resilience and Failover lifecycle. It focuses on distributed resilience, failover coordination, and survivability validation.
...
- Define the operational condition represented by **Cross Region Kubernetes Resilience**.
...
- [kubernetes-node-recovery](/scenarios/level-3-recovery/kubernetes-node-recovery)
- [kubernetes-service-recovery](/scenarios/level-3-recovery/kubernetes-service-recovery)
...
- [multi-region-service-failover-resilience](/scenarios/level-4-resilience/multi-region-service-failover-resilience)
...
**Cross Region Kubernetes Resilience** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
