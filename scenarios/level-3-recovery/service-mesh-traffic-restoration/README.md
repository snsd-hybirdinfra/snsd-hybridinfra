...
This scenario documents service mesh traffic restoration within the Recovery and Automation lifecycle. It focuses on incident response, recovery workflow execution, and restoration validation.
...
- Define the operational condition represented by **Service Mesh Traffic Restoration**.
...
- [service-mesh-latency-correlation](/scenarios/level-2-correlation/service-mesh-latency-correlation)
- [traffic-spike-correlation](/scenarios/level-2-correlation/traffic-spike-correlation)

### Same-Level Scenarios

- [traffic-restoration-workflow](/scenarios/level-3-recovery/traffic-restoration-workflow)
...
**Service Mesh Traffic Restoration** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
