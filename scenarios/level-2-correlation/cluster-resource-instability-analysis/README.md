...
| Field | Value |
|---|---|
| Scenario Name | cluster-resource-instability-analysis |
...
| Status | draft |
| Scenario Path | scenarios/level-2-correlation/cluster-resource-instability-analysis |

---

## Overview

This scenario documents cluster resource instability analysis within the Correlation and Analysis lifecycle. It focuses on multi-signal correlation, dependency analysis, and service impact reasoning.
...
- Define the operational condition represented by **Cluster Resource Instability Analysis**.
...
**Cluster Resource Instability Analysis** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
