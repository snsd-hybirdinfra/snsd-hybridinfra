...
This scenario defines the visibility scope for **Bgp Neighbor Visibility**. It focuses on collecting, organizing, and presenting operational signals so that infrastructure state can be understood before deeper correlation or recovery decisions are required.

- **Primary visibility target:** BGP neighbor, router, route table, WAN path
