...
| Field | Value |
|---|---|
| Scenario Name | compute-failover-orchestration |
...
This scenario documents compute failover orchestration within the Recovery and Automation lifecycle. It focuses on incident response, recovery workflow execution, and restoration validation.
...
- Define the operational condition represented by **Compute Failover Orchestration**.
...
**Compute Failover Orchestration** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
