...
echo "[INFO] SNSD linux observability runtime orchestration started"
...
echo "[STEP] preflight linux observability runtime"
bash "${LAB_DIR}/scripts/preflight.sh"

echo "[STEP] setup linux observability workspace"
bash "${LAB_DIR}/scripts/setup.sh"

echo "[STEP] validate linux observability runtime"
...
| Linux observability setup | PASS |
| Linux signal collection | PASS |
| Observability report generation | PASS |
