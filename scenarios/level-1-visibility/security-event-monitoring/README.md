...
| Field | Value |
|---|---|
| Scenario Name | security-event-monitoring |
...
| Status | draft |
| Scenario Path | scenarios/level-1-visibility/security-event-monitoring |

---

## Overview

This scenario documents security event monitoring within the Visibility and Detection lifecycle. It focuses on visibility, telemetry collection, health detection, and operational status awareness.
...
- Define the operational condition represented by **Security Event Monitoring**.
...
**Security Event Monitoring** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
