# Database Runtime Visibility

## Scenario Metadata

| Field | Value |
|---|---|
| Scenario Name | database-runtime-visibility |
...
| Status | draft |
| Scenario Path | scenarios/level-1-visibility/database-runtime-visibility |

---

## Overview

This scenario documents database runtime visibility within the Visibility and Detection lifecycle. It focuses on visibility, telemetry collection, health detection, and operational status awareness.
...
- Define the operational condition represented by **Database Runtime Visibility**.
...
**Database Runtime Visibility** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
