...
Use this section as the primary reading path for repository review.
...
The primary reviewer path should use `docs/` and `validation-reports/` first.
The `reports/` directory is primarily maintainer-oriented generated output.
...
The local hybrid infrastructure lab supports a runtime validation pipeline.
...
Primary execution command from WSL:
