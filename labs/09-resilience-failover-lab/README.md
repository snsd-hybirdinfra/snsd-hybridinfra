...
| Field | Value |
|---|---|
| Lab Name | `09-resilience-failover-lab` |
| Status | draft |
...
Failover coordination and distributed resilience validation.
...
## Lab Runtime Components

- [Shared Runtime](./shared-runtime/README.md)
- [Runtime Runners](./shared-runtime/runners/README.md)
- [Runtime Validators](./shared-runtime/validators/README.md)
- [Runtime Parsers](./shared-runtime/parsers/README.md)
