...
This scenario documents distributed connectivity survivability within the general infrastructure
...
- Define the scenario-specific general infrastructure signal represented by distributed-connectivity-survivability.
...
This scenario defines the resilience scope for **Distributed Connectivity Survivability**. It focuses on maintaining operational survivability when the following capability becomes degraded, unstable, or dependent on coordinated failover behavior:
