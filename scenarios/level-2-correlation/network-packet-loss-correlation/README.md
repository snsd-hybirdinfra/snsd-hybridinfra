...
| Field | Value |
|---|---|
| Scenario Name | network-packet-loss-correlation |
...
| Status | draft |
| Scenario Path | scenarios/level-2-correlation/network-packet-loss-correlation |

---

## Overview

This scenario documents network packet loss correlation within the Correlation and Analysis lifecycle. It focuses on multi-signal correlation, dependency analysis, and service impact reasoning.
...
- Define the operational condition represented by **Network Packet Loss Correlation**.
...
- [network-path-dependency-analysis](/scenarios/level-2-correlation/network-path-dependency-analysis)
...
**Network Packet Loss Correlation** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
