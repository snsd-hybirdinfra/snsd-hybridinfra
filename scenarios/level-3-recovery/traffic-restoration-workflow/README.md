...
This scenario documents traffic restoration workflow within the Recovery and Automation lifecycle. It focuses on incident response, recovery workflow execution, and restoration validation.
...
- Define the operational condition represented by **Traffic Restoration Workflow**.
...
- [traffic-spike-correlation](/scenarios/level-2-correlation/traffic-spike-correlation)

### Same-Level Scenarios

- [service-mesh-traffic-restoration](/scenarios/level-3-recovery/service-mesh-traffic-restoration)
...
- [service-mesh-traffic-visibility](/scenarios/level-1-visibility/service-mesh-traffic-visibility)

---
## Summary

**Traffic Restoration Workflow** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
