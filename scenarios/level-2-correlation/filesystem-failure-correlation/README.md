...
This scenario documents filesystem failure correlation within the Correlation and Analysis lifecycle. It focuses on multi-signal correlation, dependency analysis, and service impact reasoning.
...
- Define the operational condition represented by **Filesystem Failure Correlation**.
...
- [filesystem-health-visibility](/scenarios/level-1-visibility/filesystem-health-visibility)
...
- [pod-failure-correlation](/scenarios/level-2-correlation/pod-failure-correlation)
...
**Filesystem Failure Correlation** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
