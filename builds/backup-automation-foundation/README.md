...
Establishes backup job automation, repository target, retention boundary, and restore-readiness validation.
...
- `/scenarios/**/backup-job-monitoring`
- `/scenarios/**/backup-failure-correlation`
- `/scenarios/**/backup-restoration-automation`
