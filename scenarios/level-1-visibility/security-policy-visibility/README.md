...
| Field | Value |
|---|---|
| Scenario Name | security-policy-visibility |
...
| Status | draft |
| Scenario Path | scenarios/level-1-visibility/security-policy-visibility |

---

## Overview

This scenario documents security policy visibility within the Visibility and Detection lifecycle. It focuses on visibility, telemetry collection, health detection, and operational status awareness.
...
- Define the operational condition represented by **Security Policy Visibility**.
...
- [security-telemetry-monitoring](/scenarios/level-1-visibility/security-telemetry-monitoring)
...
**Security Policy Visibility** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
