...
This scenario documents api latency correlation within the Correlation and Analysis lifecycle. It focuses on multi-signal correlation, dependency analysis, and service impact reasoning.
...
- Define the operational condition represented by **Api Latency Correlation**.
...
- [api-gateway-health-monitoring](/scenarios/level-1-visibility/api-gateway-health-monitoring)
...
- [api-service-recovery](/scenarios/level-3-recovery/api-service-recovery)
...
**Api Latency Correlation** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
