# Execution Evidence - Security Policy Violation Analysis

## Execution Context

This scenario models an operational workflow for **security operations** in the **Correlation** lifecycle.
