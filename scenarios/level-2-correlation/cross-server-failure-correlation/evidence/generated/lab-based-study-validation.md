# Lab-Based Study Validation: cross-server-failure-correlation
...
This study record explains how cross server failure correlation is validated using the mapped lab runtime.
