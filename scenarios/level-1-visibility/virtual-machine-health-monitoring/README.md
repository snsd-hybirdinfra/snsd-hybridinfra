...
This scenario documents virtual machine health monitoring within the Visibility and Detection lifecycle. It focuses on visibility, telemetry collection, health detection, and operational status awareness.
...
- Define the operational condition represented by **Virtual Machine Health Monitoring**.
...
- [virtual-machine-restoration](/scenarios/level-3-recovery/virtual-machine-restoration)

---
## Summary

**Virtual Machine Health Monitoring** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
