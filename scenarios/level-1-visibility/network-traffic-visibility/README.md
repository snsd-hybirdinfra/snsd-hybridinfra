...
This scenario documents network traffic visibility within the Visibility and Detection lifecycle. It focuses on visibility, telemetry collection, health detection, and operational status awareness.
...
- Define the operational condition represented by **Network Traffic Visibility**.
...
**Network Traffic Visibility** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
