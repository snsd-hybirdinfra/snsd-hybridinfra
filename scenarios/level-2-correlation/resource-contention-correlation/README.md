# Resource Contention Correlation

## Scenario Metadata

| Field | Value |
|---|---|
| Scenario Name | resource-contention-correlation |
| Lifecycle Level | level-2-correlation |
| Scenario Path | scenarios/level-2-correlation/resource-contention-correlation |
...
This scenario documents resource contention correlation within the general infrastructure
...
- Define the scenario-specific general infrastructure signal represented by resource-contention-correlation.
...
This scenario defines the correlation scope for **Resource Contention Correlation**. It focuses on connecting telemetry symptoms, dependency context, and operational impact before recovery or escalation decisions are made.
...
The primary operational risk is **misdiagnosis, isolated symptom handling, and delayed incident qualification**. In the context of **Resource Contention Correlation**, this means the workflow must clearly separate observable symptoms, dependency context, response boundaries, and validation evidence.
