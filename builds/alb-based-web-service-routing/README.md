...
Builds application load balancing, listener routing, target health checks, and web service traffic distribution.
...
- `/scenarios/**/load-balancer-health-monitoring`
- `/scenarios/**/api-latency-correlation`
- `/scenarios/**/load-balancer-recovery`
