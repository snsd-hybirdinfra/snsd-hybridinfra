# Execution Evidence - Virtual Machine Health Monitoring

## Execution Context

This scenario models an operational workflow for **hybrid infrastructure operations** in the **Visibility** lifecycle.
