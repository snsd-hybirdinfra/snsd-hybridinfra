...
- Focus: Network routing, VPN, WAN, DNS, load balancing, reachability, latency, and route recovery validation.
...
This lab validates network-oriented visibility, correlation, and recovery scenarios by preparing routing nodes, inspecting route state, validating reachability, checking DNS resolution, measuring latency and packet loss, and generating evidence outputs for mapped scenarios.
