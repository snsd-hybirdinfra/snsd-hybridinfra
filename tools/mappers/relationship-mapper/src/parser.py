...
def parse_relationship_graph(data: dict) -> RelationshipGraph:
    ...
    return RelationshipGraph(
        ...
        related_visibility=relationships.get("related_visibility", []),
        related_correlation=relationships.get("related_correlation", []),
        related_recovery=relationships.get("related_recovery", []),
        related_resilience=relationships.get("related_resilience", []),
        related_continuity=relationships.get("related_continuity", []),
