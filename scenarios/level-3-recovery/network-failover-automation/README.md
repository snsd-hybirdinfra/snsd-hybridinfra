...
| Field | Value |
|---|---|
| Scenario Name | network-failover-automation |
...
| Status | draft |
| Scenario Path | scenarios/level-3-recovery/network-failover-automation |

---

## Overview

This scenario documents network failover automation within the Recovery and Automation lifecycle. It focuses on incident response, recovery workflow execution, and restoration validation.
...
- Define the operational condition represented by **Network Failover Automation**.
...
**Network Failover Automation** contributes to the scenario-driven infrastructure operations portfolio by documenting an operational condition, lifecycle workflow, supporting modules and adapters, validation criteria, diagram artifact, and public-safe evidence package.
